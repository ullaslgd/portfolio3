  ...
  return (
    <section id="about" className='flex justify-evenly flex-row-reverse gap-1 mt-[40px] w-[90%] max-w-[95vw] rounded-[15px] bg-[#FFFEFD] p-5 pt-6  border-2 border-zinc-200'>
       <div className='lg:max-w-[40vw] flex flex-col justify-start md:max-w-[30vw]'>
        ...
        <p className="lg:text-[20px] text-[16px] mt-6 text-gray-800 font-Poppins">Hey, I’m a 20-year-old web and app developer who’s really passionate about creating great digital experiences. I’m skilled in Next.js and React Native, and I love building apps that work smoothly across both web and mobile. I’m always curious about how things work and love diving into new technologies to see how they can make projects better, faster, or more fun to use..</p>
        ...
        <a href="#" className="text-[#5865f2] hover:text-[#6300f7] font-Poppins">#appdeveloper</a>
        </div>
        </div>
