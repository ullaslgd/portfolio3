...
const About = () => {
  return (
    <section id="about" className='flex  flex-col gap-1 lg:absolute lg:bottom-[26%] mt-[40px] w-[90%] max-w-[450px] rounded-[15px] bg-[#FFFEFD] p-5 pt-6  border-2 border-zinc-200'>
