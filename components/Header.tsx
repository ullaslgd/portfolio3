...
const Header = () => {
  ...
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div className="mt-5 max-w-3xl text-center mx-auto">
      <p className="text-lg text-gray-600 py-4 font-Poppins">I make cool websites, apps and games okay.</p>
    </div>


    <div className="mt-8 gap-3 flex justify-center">
      <a className="inline-flex justify-center items-center gap-x-3 text-center bg-gradient-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 border border-transparent text-white text-sm font-medium rounded-md focus:outline-none focus:from-violet-600 focus:to-blue-600 py-3 px-4" href="/cv.pdf" download={true}>
        Download CV
 ...
 <Link href='https://github.com/ullaslgd'> git hub </Link>
